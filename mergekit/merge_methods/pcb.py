...
class PCBMerge(MergeMethod):
    ...
    def pretty_name(self) -> Optional[str]:
        return "Parameter Competition Balancing"
    ...
    def parameters(self) -> List[ConfigParameterDef]:
        return [
            ConfigParameterDef(name="density", required=False, default_value=0.9),
    ...
    def make_task(
        ...
        base_model: Optional[ModelReference], # "pcb": "[PCB](https://arxiv.org/abs/2410.02396)",
